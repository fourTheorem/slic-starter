...
export function addEntry({ listId, title, value }) {
  ...
  return function(dispatch) {
    ...
    AmplifyApi.post('checklist-api', `/checklist/${listId}/entries`, {
      body: {
        title,
        value
      }
...
export function loadEntries({ listId }) {
  ...
  return function(dispatch) {
    ...
    AmplifyApi.get('checklist-api', `/checklist/${listId}/entries`)
      .then(result => {
...
export function removeEntry({ listId, entId }) {
  return function(dispatch) {
    ...
    AmplifyApi.del('checklist-api', `/checklist/${listId}/entries/${entId}`)
      .then(result => {
